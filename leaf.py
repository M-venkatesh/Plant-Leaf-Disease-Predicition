...
filepath = r'C:\Users\Venky M\Downloads\Plant-Leaf-Disease-Prediction/model.h5'
...
def pred_tomato_dieas(tomato_plant):
  ...
  if pred==0:
      ...
      return "No disease found,Leaf is fine","index.html"
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join(r'C:\Users\Venky M\Downloads\Plant-Leaf-Disease-Prediction\static\upload', filename)
        file.save(file_path)
